  ...
  return (
    <main className="flex justify-center w-screen min-h-[900px] lg:min-h-none">
      <div className="p-8 w-full max-w-[800px] mx-auto">
        ...
        <h2 className="md:text-lg pb-8 border-b mb-4 px-2 md:px-8">Built with <a className="text-blue-600 font-semibold underline" href="https://ui.shadcn.com/">shadcn</a> — includes multi-month views, text entry, preset ranges, responsive design and date range comparisons.</h2>
        ...
        <div className="px-2 md:px-8">
          ...
          <p className="pb-8">Check out the project on Github for the source and docs.</p>
