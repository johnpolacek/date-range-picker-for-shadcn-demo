  ...
  return (
    <main className="flex justify-center w-screen min-h-[900px] lg:min-h-none">
      <div className="p-8 w-full max-w-[800px] mx-auto">
        ...
        <div className="flex grow shrink-0 basis-[370px] flex-row justify-end items-end relative z-20 px-8">
          <div className="grow">
        ...
        <div className="w-full text-right text-4xl pr-12 -ml-2 pt-6 pb-8 md:pb-12"><span className="text-sm relative -top-1 italic opacity-50">click it</span>☝️</div>
